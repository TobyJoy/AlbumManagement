...
RSpec.describe MusicAlbumsController, type: :controller do
  ...
  describe 'GET #index' do
    ...
    it "gets all music albums to load index" do
      user = User.first
      albums  = create(:music_album, name: "Dhangal", genres: "Bollywood", artist: "Toby", user_id: user.id)
      get :index
